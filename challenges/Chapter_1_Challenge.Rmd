...
sub_sp_500_prices_tbl <- select(sp_500_prices_tbl,  symbol, date, adjusted)
sub_sp_500_prices_tbl <- filter(sub_sp_500_prices_tbl, date >= "2018-01-01")
sub_sp_500_prices_tbl %>% glimpse()

# 0utput: sp_500_daily_returns_tbl
```
```{r}
sp_500_dayl <- read_rds("/home/abbasi/Desktop/R/raw_data/sp_500_daily_returns_tbl.rds")
sp_500_dayl %>% glimpse()
```
...
```{r}
sp_500_daily_returns_tbl <- read_rds("/home/abbasi/Desktop/R/raw_data/sp_500_daily_returns_tbl.rds")
...
We're going to import the correct results first (just in case you were not able to complete the last step).
```{r}
stock_date_matrix_tbl <- read_rds("/home/abbasi/Desktop/R/raw_data/stock_date_matrix_tbl.rds")
...
We're going to import the correct results first (just in case you were not able to complete the last step).
```{r}
k_means_mapped_tbl <- read_rds("/home/abbasi/Desktop/R/raw_data/k_means_mapped_tbl.rds")
```
...
```{r}
k_means_mapped_tbl <- read_rds("/home/abbasi/Desktop/R/raw_data/k_means_mapped_tbl.rds")
umap_results_tbl   <- read_rds("/home/abbasi/Desktop/R/raw_data/umap_results_tbl.rds")
umap_results_tbl 
```
